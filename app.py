...
st.set_page_config(
    page_title="Decision Intelligence Engine",
    layout="wide",
...
if logo_path.exists():
    ...
    header_html += '⚙️'
header_html += '<h1 class="custom-header-title">Decision Intelligence Engine</h1></div>'
st.markdown(header_html, unsafe_allow_html=True)

# --- Hero Section ---
st.markdown("""
<div class="hero-section">
    <h1 class="hero-title">Welcome to the Decision Intelligence Engine</h1>
